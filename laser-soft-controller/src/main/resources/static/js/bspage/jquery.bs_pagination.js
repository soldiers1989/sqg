    ...
    var methods = {
            ...
            return this.each(function() {
                ...
                if(settings.bootstrap_version == "3") {
                    ...
                    if(settings.showRowsInfo) {
                        html += '<div style="margin-top:5px;" class="' + settings.navInfoContainerClass + '">';
                    ...
                    if(settings.showGoToPage && settings.visiblePageLinks < settings.totalPages) {
                        html += '<div style="width:120px;" class="' + settings.navGoToPageContainerClass + '">';
                    ...
                    if(settings.showRowsPerPage) {
                        html += '<div style="width:120px;" class="' + settings.navRowsPerPageContainerClass + '">';
                        html += '<div class="input-group">';
        ...
        getDefaults: function(bootstrap_version) {
            var default_settings = {
                ...
                navGoToPageContainerClass: "col-xs-6 col-sm-4 col-md-2 row-space pull-right",
                navGoToPageIconClass: "glyphicon glyphicon-arrow-right",
                navGoToPageClass: "form-control small-input",

                navRowsPerPageContainerClass: "col-xs-6 col-sm-4 col-md-2 row-space pull-right",
                navRowsPerPageIconClass: "glyphicon glyphicon-th-list",
                navRowsPerPageClass: "form-control small-input",

                navInfoContainerClass: " pull-right", //改过col-xs-12 col-sm-4 col-md-2 row-space
                navInfoClass: "",
        ...
        if(s.showRowsInfo && s.showRowsDefaultInfo) {
            var page_first_row = ((s.currentPage - 1) * s.rowsPerPage) + 1,
                ...
                info_html = page_first_row + "-" + page_last_row + " " +
                    ...
                    " (" + rsc_bs_pag.current_page_abbr_label + s.currentPage + rsc_bs_pag.total_pages_abbr_label + s.totalPages + rsc_bs_pag.current_page_label + ")",
