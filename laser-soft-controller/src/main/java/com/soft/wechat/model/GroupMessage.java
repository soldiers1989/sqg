...
public class GroupMessage extends UserMessage {
    ...
    public String toString() {
        ...
        return "GroupMessage(" + "groupId='" + groupId + '\'' + ", group_owner_uin='" + group_owner_uin + '\'' + ", group_name='"
                        + group_name + '\'' + ", group_count='" + group_count + '\'' + ", user_attrstatus='" + user_attrstatus + '\''
                        + ", user_display_name='" + user_display_name + '\'' + ", user_nickname='" + user_nickname + '\''
                        + ", recall_msg_id='" + recall_msg_id + '\'' + ", sys_notif='" + sys_notif + '\'' + ", time='" + time + '\''
                        + ", timestamp='" + timestamp + '\'' + ", log='" + log + '\'' + ')';
    }
}
